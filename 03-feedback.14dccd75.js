...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}let a={},o={form:document.querySelector(".feedback-form"),email:document.querySelector("[name='email']"),message:document.querySelector("[name='message']"),buttonSubmit:document.querySelector("[type='submit']")};function r(e){a[e.target.name]=e.target.value,localStorage.setItem("feedback-form-state",JSON.stringify(a))}function m(e){e.preventDefault(),o.form.reset(),localStorage.removeItem("feedback-form-state"),console.log(a)}window.onload=(()=>{let e=localStorage.getItem("feedback-form-state");if(e){let t=JSON.parse(e);a={...t},o.email.value=t.email,o.message.value=t.message}}),o.form.addEventListener("submit",m),o.form.addEventListener("input",(0,e.default)(r,500));
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.14dccd75.js.map