...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}let a={email:"",message:""},o={form:document.querySelector(".feedback-form"),email:document.querySelector("[name='email']"),message:document.querySelector("[name='message']"),buttonSubmit:document.querySelector("[type='submit']")};function l(e){a[e.target.name]=e.target.value,localStorage.setItem("feedback-form-state",JSON.stringify(a))}function r(e){e.preventDefault(),""!==o.email.value&&""!==o.message.value?(o.form.reset(),localStorage.removeItem("feedback-form-state"),console.log(a),a={}):alert("Не всі поля зопавненні! Перевірте введені дані.")}window.onload=(()=>{let e=localStorage.getItem("feedback-form-state");if(e){let t=JSON.parse(e);a={...a,...t},console.log(a),o.email.value=a.email,o.message.value=a.message}}),o.form.addEventListener("submit",r),o.form.addEventListener("input",(0,e.default)(l,500));
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.0e727532.js.map